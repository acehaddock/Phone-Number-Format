...
export class PhoneNumberFormatVM {
    ...
    try {
      if (this.countryCode) {
        ...
        if (this.phoneNumberUtil.isValidNumberForRegion(this.parsedPhoneNumber, this.countryCode)) {
          this.phoneNumber = this.phoneNumberUtil.format(this.parsedPhoneNumber, PhoneNumberFormat.E164);
          this.isValidPhoneNumber = true;
        } else {
