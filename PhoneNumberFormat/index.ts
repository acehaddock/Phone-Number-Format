...
import { PhoneNumberFormatVM } from "./viewmodels/PhoneNumberFormatVM";
import { CdsService } from "./viewmodels/CdsService";
import { initializeIcons } from "@uifabric/icons";
initializeIcons();

export class PhoneNumberFormat implements ComponentFramework.StandardControl<IInputs, IOutputs> {
